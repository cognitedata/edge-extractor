...
func main() {
	...
	// defer camera.Close()
	cam, err := ffmpeg.NewRtspCamera("1", "admin", "kiborgi1706", "192.168.86.230:554/Streaming/Channels/1/")
	if err != nil {
		fmt.Println(err)
		return
	}
	...
	cam2, err := ffmpeg.NewRtspCamera("2", "admin", "kiborgi1706", "192.168.86.230:554/Streaming/Channels/2/")
	if err != nil {
		fmt.Println(err)
		return
	}
